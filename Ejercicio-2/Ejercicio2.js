...
var operations = " 44/8/8+2-5-200+500 ";
//var multi = multOrDiv(multiplicacion);
function divideStrings(string) {
  // Funcion para dividir la cadena en numeeros y simbolos

  if (string.lenght > 20) {
    console.log("cadena demasiado larga");
  }
...
function multOrDiv(operators) {
  // funcion para realizar las mutiplicaciones /diviciones , en el orden de izquierda ad erecha que se encuentren en la cadena
  while (
    ...
    if ((i < j && i != -1) || j == -1) {
      // se compara si el simbolo encontrado es una multiplicacion o division
...
console.log("Estas fueron las operaciones", operations);
